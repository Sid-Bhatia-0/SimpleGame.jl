...
const TRANSPARENT = BinaryTransparentColor(zero(CT.RGBA{FPN.N0f8}))
...
COLORS[Integer(SI.COLOR_INDEX_TEXT)] = BinaryTransparentColor(CT.RGBA{FPN.N0f8}((Colors.color_names["white"] ./ 255)...,))
...
# Text
COLORS[Integer(SI.COLOR_INDEX_TEXT_BACKGROUND_NEUTRAL)] = TRANSPARENT
COLORS[Integer(SI.COLOR_INDEX_TEXT_BACKGROUND_HOT)] = TRANSPARENT
COLORS[Integer(SI.COLOR_INDEX_TEXT_BACKGROUND_ACTIVE)] = TRANSPARENT

COLORS[Integer(SI.COLOR_INDEX_TEXT_BORDER_NEUTRAL)] = TRANSPARENT
COLORS[Integer(SI.COLOR_INDEX_TEXT_BORDER_HOT)] = TRANSPARENT
COLORS[Integer(SI.COLOR_INDEX_TEXT_BORDER_ACTIVE)] = TRANSPARENT
